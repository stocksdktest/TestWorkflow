...
args = {
    'owner': 'airflow',
    'start_date': timezone.datetime(2019, 11, 20, 11, 27),
}


with DAG(
    dag_id='StockSDKTest_Time2',
    default_args=args,
    schedule_interval=datetime.timedelta(minutes=4),
) as dag:
...
if __name__ == "__main__":
    print(airflow.utils.dates.days_ago(0))
    # dag.cli()
