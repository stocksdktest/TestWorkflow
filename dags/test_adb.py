...
with DAG(
	...
	task_id_to_cmp_list1 = ['adb_shell_cmp_a1','adb_shell_cmp_b1']
	task_id_to_cmp_list2 = ['adb_shell_cmp_a2','adb_shell_cmp_b2']
	task_id_to_cmp_list3 = ['adb_shell_cmp_a3','adb_shell_cmp_b3']
	...
	android_3 = AndroidRunnerOperator(
		...
		apk_id='com.chi.ssetest',
		apk_version='release-20191016-0.0.3',
		runner_conf=runner_conf_list2[0]
	)
	...
	android_4 = AndroidRunnerOperator(
		...
		apk_id='com.chi.ssetest',
		apk_version='release-20191016-0.0.3',
		runner_conf=runner_conf_list2[1]
	)
